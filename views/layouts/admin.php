...
//        'brandUrl' => Yii::$app->homeUrl,
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Глоссарий', 'url' => ['/admin/glossary/index']],
            ['label' => 'Курс криптовалют', 'url' => ['/admin/rate/index']],
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; WoopCoin <?= date('Y') ?></p>
